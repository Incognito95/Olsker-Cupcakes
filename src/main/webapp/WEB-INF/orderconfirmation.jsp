...
<t:genericpage>
    ...
    <jsp:body>
        ...
        <div class="p-3 mb-2 bg-success rounded-3">
            <div class="container-fluid py-1 d-flex justify-content-center mt-2">
                <h1 class="display-5 fw-bold">ORDER CONFIRMATION</h1><br>
            </div>
            <p class="col-md-3 fs-3">${sessionScope.email}, thank you for your order!<br> We've received your order and</p>
        </div>
        </div>
